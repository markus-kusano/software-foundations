...
Proof.
  intros p. induction p as [n m]. simpl. reflexivity.
Qed.
...
Fixpoint subset (s1:bag) (s2:bag) : bool :=
  match s1 with 
    | nil => true (* nil is a subset of every list *)
    | h :: t => 
        if (member h s2) 
...
(* Lemma to help us prove rev_involutive *)
...
(* i wonder if that's the simple solution or not *)
